...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Category/index');?>">分类管理</a><span class="crumb-step">&gt;</span><span>修改分类</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" name="name" type="text" placeholder="<?php echo ($data1['name']); ?>" >
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="pid" class="required">
                                        ...
                                        <option value="0" <?php if($data1["pid"] == 0 ): ?>selected="selected"<?php endif; ?> >顶级分类</option>
                                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>" <?php if($data1["pid"] == $vol["id"] ): ?>selected="selected"<?php endif; ?> >
                                                <?php echo (str_repeat('&nbsp;',$vol["ge"] * 3)); ?>
                                                <?php echo ($vol["name"]); ?>
